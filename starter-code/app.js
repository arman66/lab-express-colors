...
// if you use views as your folder name its the defaul and the next line is no needed
// app.set('views','views');
...
app.get("/",(req,res,next)=>{
  //creaes a variable myNmae for use in the ejs
...
app.get("/colors",(req,res,next)=>{
  //creaes a variable myNmae for use in the ejs
  res.locals.colorArray = myColors;
